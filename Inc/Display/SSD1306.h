...
// * @param  color: Color used for drawing. This parameter can be a value of @ref SSD1306_COLOR_t enumeration
// */
//void SSD1306_DrawSprite(const SpriteDef_t *image, SSD1306_COLOR_t color);
//
///**
...
// */
//void SSD1306_DrawSprite(const SpriteDef_t *image, SSD1306_COLOR_t color, uint16_t xloc, uint16_t yloc);
